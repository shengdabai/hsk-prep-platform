...
export function AdminShell({
  ...
  return (
    <div className="mx-auto grid max-w-7xl gap-8 px-6 py-8 lg:grid-cols-[220px_minmax(0,1fr)] lg:px-10">
      <aside className="space-y-2 rounded-[2rem] border border-stone-900/10 bg-[#f1e8d9] p-5 text-sm">
        ...
        <Link href="/admin/items" className="block rounded-full px-4 py-2 hover:bg-white/70">题目管理</Link>
        ...
        <Link href="/admin/generate" className="block rounded-full px-4 py-2 hover:bg-white/70">AI 生成题目</Link>
        ...
        <Link href="/admin/users" className="block rounded-full px-4 py-2 hover:bg-white/70">用户只读</Link>
      </aside>

...
// 模拟考详情页错误边界。
export default function MockExamDetailError({
  error,
  reset,
}: {
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col items-center px-6 py-20 text-center">
      ...
      <h1 className="mt-3 text-3xl font-semibold text-stone-950">无法加载该模拟考</h1>
      <p className="mt-3 text-sm leading-7 text-stone-600">载入考卷详情时出错,请重试。</p>
      {error.digest ? (

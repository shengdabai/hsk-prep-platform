...
// Admin 区错误边界(覆盖 admin 及未自带 error 的子路由)。
export default function AdminError({
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col items-center px-6 py-20 text-center">
      <div className="text-xs uppercase tracking-[0.28em] text-stone-500">管理后台出错</div>
      <h1 className="mt-3 text-3xl font-semibold text-stone-950">无法加载后台数据</h1>
